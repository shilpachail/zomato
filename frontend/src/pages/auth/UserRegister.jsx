...
const UserRegister = () => {
  ...
  // cors orgin policy  it is a browser security feature that control web pages can request resources from diffeent domain than the one that served the page
 // in backend down;load cors package
  // axios package is use to send data from frontend to backend
        ...
        {
            withCredentials: true // iske  wajha se cookies ke aandar token save hoga
        })
